<template>
    <div class="map-wrapper">
        ...
        <div class="detail-driver">
            ...
            <div class="toggle-bar">
                <div>
                    <select id="select-person">
                        <!-- 나중에 DB에서 불러올 때 보호자의 <아이디 또는 고유인식번호>로 관리하는 환자의 이름을 불러올 것임 (로직추가예정)-->
                        <option v-for="(person, index) in persons" :value=person.name :key="index"></option>
                    </select>
                    
                    <span>환자이름</span><!-- 위 코드 추가되면 이 부분은 지워야합니다-->

                </div>
                <div class="btn-time" style="width: 100px;">
            ...
            <!-- 위치 아이템 예시 -->
            <!-- 이제 좌표값을 기준으로 주소를 받아오는 로직 생성해서 바꿔야함 -->

<template>
    <div class="page-container">
        ...
        <div class="page-containera">
            <div id="map" ref="mapContainer" class="map-area"></div>
        </div>
...
const dummyData = ref({
    ...
    "destinations_by_distance": {
        "500m": [
            { "destination_id": 1, "latitude": 37.496825, "longitude": 126.88546, "visit_count": 53, "distance_meters": 328, "name": "도서관에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 2, "latitude": 37.492829, "longitude": 126.887768, "visit_count": 46, "distance_meters": 184.3, "name": "구로중앙로에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 3, "latitude": 37.497062, "longitude": 126.892239, "visit_count": 36, "distance_meters": 490.4, "name": "도로에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 4, "latitude": 37.493286, "longitude": 126.884334, "visit_count": 33, "distance_meters": 327.8, "name": "도로에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 5, "latitude": 37.495341, "longitude": 126.889028, "visit_count": 32, "distance_meters": 149, "name": "도로에 있을 것 같아요!", "sgg_nm": "구로구 구로동" }
        ],
        "1000m": [
            { "destination_id": 6, "latitude": 37.486667, "longitude": 126.888185, "visit_count": 45, "distance_meters": 870.5, "name": "남구로역에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 7, "latitude": 37.489739, "longitude": 126.887963, "visit_count": 45, "distance_meters": 528.4, "name": "청암한의원에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 8, "latitude": 37.498004, "longitude": 126.884143, "visit_count": 38, "distance_meters": 502.9, "name": "오공오약국에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 9, "latitude": 37.49082, "longitude": 126.891015, "visit_count": 33, "distance_meters": 500.3, "name": "공원에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 10, "latitude": 37.498343, "longitude": 126.893059, "visit_count": 30, "distance_meters": 636.5, "name": "도로에 있을 것 같아요!", "sgg_nm": "구로구 구로동" }
        ],
        "1500m": [
            { "destination_id": 11, "latitude": 37.485114, "longitude": 126.888224, "visit_count": 42, "distance_meters": 1043.1, "name": "편의점에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 12, "latitude": 37.482068, "longitude": 126.888452, "visit_count": 42, "distance_meters": 1382.3, "name": "훈춘식당에 있을 것 같아요!", "sgg_nm": "구로구 가리봉동" },
            { "destination_id": 13, "latitude": 37.487777, "longitude": 126.895622, "visit_count": 14, "distance_meters": 1020.7, "name": "거리에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 14, "latitude": 37.485769, "longitude": 126.898204, "visit_count": 13, "distance_meters": 1339.4, "name": "복지센터에 있을 것 같아요!", "sgg_nm": "구로구 구로동" },
            { "destination_id": 15, "latitude": 37.489937, "longitude": 126.903709, "visit_count": 6, "distance_meters": 1498, "name": "거리에 있을 것 같아요!", "sgg_nm": "영등포구 대림동" }
        ]
    },
...
async function processDestinationsToZones(apiResponse) {
    ...
    const mapToZone = (dest) => ({
        ...
        address2: dest.name,       // "구로중앙로에 있을 것 같아요!" 등
        sgg_nm: dest.sgg_nm,

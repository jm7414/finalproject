<template>
  <div class="desktop-community-page">
    <!-- 게시판 네비 바 -->
    <nav class="top-nav">
      <button type="button" class="top-nav-item" :class="{ active: activeTab === 'Post' }" @click="changeTab('Post')">
      ...
      <button type="button" class="top-nav-item" :class="{ active: activeTab === 'Missing' }" @click="changeTab('Missing')">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <button type="button" class="top-nav-item" :class="{ active: activeTab === 'Event' }" @click="changeTab('Event')">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M4 11c0-3.866 3.134-7 7-7s7 3.134 7 7v5c0 3.866-3.134 7-7 7s-7-3.134-7-7v-5z"></path>
          <path d="M9 11c0-1.657 1.343-3 3-3s3 1.343 3 3v5c0 1.657-1.343 3-3 3s-3-1.343-3-3v-5z"></path>
...
import CommunityMissing from '@/components/desktop/DesktopCommunityMissing.vue';
import CommunityBoard from '@/components/desktop/DesktopCommunityBoard.vue';
import CommunityEvent from '@/components/desktop/DesktopCommunityEvent.vue';

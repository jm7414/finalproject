...
// 이웃용 푸터: 일정, 홈, 공지 3개 탭
const navItems = ref([
  { name: '일정', path: null, svg: `<path d="M20 5H19V3H17V5H9V3H7V5H6C4.9 5 4 5.9 4 7L4 21C4 22.1 4.9 23 6 23H20C21.1 23 22 22.1 22 21V7C22 5.9 21.1 5 20 5ZM20 21H6V11H20V21ZM20 9H6V7H20V9ZM10 15H8V13H10V15ZM14 15H12V13H14V15ZM18 15H16V13H18V15ZM10 19H8V17H10V19ZM14 19H12V17H14V19ZM18 19H16V17H18V19Z" />` },
  ...
  { name: '공지', path: null, svg: `<path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM13 17H11V15H13V17ZM13 13H11V7H13V13Z" />` },
]);
